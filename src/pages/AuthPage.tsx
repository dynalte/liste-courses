...
/**
 * Connexion / inscription à une famille EXISTANTE uniquement.
 * La création de famille est désactivée (voir ALLOW_REGISTER côté PHP) :
 * les nouveaux membres passent par "Rejoindre" avec le code d'invitation.
 */
    ...
    <IonPage>
      ...
      <IonContent className="ion-padding">
        ...
        <IonButton expand="block" onClick={submit} disabled={busy}>
          {busy ? '…' : mode === 'login' ? 'Se connecter' : 'Rejoindre'}
        </IonButton>
